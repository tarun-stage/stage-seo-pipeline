...
|----------|------|--------|--------------|
| 1 | VideoObject schema on all /watch/* pages | ✅ Added (movies + show episodes, PR #1413) | 2026-04-27 |
| 2 | FAQPage schema on all 4 dialect landing pages | ✅ Added (haryanvi, rajasthani, bhojpuri, gujarati) | 2026-04-24 |
...
| 5 | BreadcrumbList on all pages | ✅ Added (dialect pages, movies, shows, content detail pages) | 2026-04-24 |
| 6 | Organization + WebSite schema on homepage | ✅ Added (root homepage + all dialect homepages) | 2026-04-24 |
| 7 | Content freshness — dateModified in JSON-LD | ✅ Added to VideoObject on watch pages; ⚠️ Movie/TVSeries on detail pages uses yearOfRelease | 2026-04-27 |
| 8 | Hreflang tags (hi ↔ en) | ✅ Added (dialect homepages have en-IN, hi-IN, x-default) | 2026-04-24 |
| 9 | Speakable schema on key landing pages | ⚠️ Partial — present in Movie/TVSeries on detail pages; not on listing pages | 2026-04-27 |
...
## Run: 2026-04-27 — Schema Audit — Technical SEO Auditor
**Hypothesis:** Adding VideoObject schema to all /watch/* pages enables Google Watch button eligibility for video content and improves AI citation signals for streaming content.
**Action:** PR #1413 (https://github.com/vatsanatech/stage-webapp/pull/1413) — added VideoObject schema to `/src/app/[lang]/[dialect]/[contentType]/watch/[...slug]/page.tsx`
- Movies: VideoObject via existing `generateVideoObjectSchema` utility with `duration`, `uploadDate`, `dateModified`, `WatchAction`
- Shows: VideoObject per episode with `name` ("ShowTitle - EpisodeTitle"), `thumbnailUrl`, `duration`, `contentUrl`, `WatchAction`
- Pre-existing schemas confirmed present (no changes needed): FAQPage on 4 dialect homepages, BreadcrumbList on all pages, Organization+WebSite on homepage, Movie/TVSeries on content detail pages
**Result:** PR raised, pending merge. 1 new schema type added (VideoObject on watch pages).
**Keep / Discard:** Keep — VideoObject with WatchAction is required for Google Watch button per Google Search Central docs.
**Confidence delta:** VideoObject on watch pages → pending confirmation after merge
...
| Pages with VideoObject schema | 0 | 2026-04-27 | ↑ All /watch/* pages (movies + show episodes) — PR #1413 pending |
| Pages with FAQPage schema | 0 | 2026-04-27 | ↑ 4 dialect homepages (haryanvi, rajasthani, bhojpuri, gujarati) |
| Pages with BreadcrumbList | 0 | 2026-04-27 | ↑ Dialect homepages, /movies, /shows, content detail pages |
...
*Last updated: 2026-04-27 — Schema Audit run by Technical SEO Auditor*
